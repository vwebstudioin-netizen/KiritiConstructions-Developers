            ...
            <div className="card p-8 md:p-10">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-5">
                  ...
                  <div><label className="block font-body text-sm font-medium text-dark mb-1.5">Phone *</label><input {...register('phone')} placeholder="+91 98765 43210" className={`input-field ${errors.phone ? 'input-error' : ''}`} />{errors.phone && <p className="error-msg">{errors.phone.message}</p>}</div>
